...
function() {
    ...
    Riode.defaults = {
        ...
        templateCartAddedAlert: '<div class="alert alert-simple alert-btn cart-added-alert"><a href="carrito.php" class="btn btn-success btn-md">Ver Carrito</a><span>"{{name}}" ha sido agregado a su carrito.</span><button type="button" class="btn btn-link btn-close"><i class="d-icon-times"></i></button></div>',
        zoomImage: {
            responsive: !0,
    ...
    n = function() {
        for (var i = t.length; i--; )
            e = t[i],
            Riode.isOnScreen(e.el, e.options.accX, e.options.accY) && ("function" == typeof $(e.el).data("appear-callback") && $(e.el).data("appear-callback").call(e.el, e.data),
        ...
        if ("function" == typeof imagesLoaded && $.fn.isotope) {
            Riode.$(e).each((function() {
                ...
                e.imagesLoaded((function() {
                    ...
                    i.customDelay && Riode.call((function() {
                        e.isotope(i)
                    }
    ...
    Riode.initShowVendorSearch = function(e) {
        Riode.$body.on("click", e, (function(e) {
            ...
            t.hasClass("open") ? t.slideUp().removeClass("open") : t.slideDown().addClass("open"),
            e.preventDefault()
        }
        ))
    }
    ...
    Riode.initFloatingElements = function(e) {
        $.fn.parallax && Riode.$(e).each((function() {
            var e = $(this);
            e.attr("data-floating-depth") ? e.children(".layer").attr("data-depth", e.attr("data-floating-depth")) : e.children(".layer").attr("data-depth", ".3"),
        ...
        if (!Riode.isMobile && "undefined" != typeof skrollr) {
            ...
            t.each((function() {
                var e = $(this)
                  ...
                  , i = [];
                e.data("options") && (t = e.data("options"),
                i = Object.keys(t)),
                "object" == typeof t && (i = Object.keys(t)).length && i.forEach((function(i) {
                    e.attr(i, t[i])
                }
                ))
            }
    ...
    Riode.stickyHeader = function(e) {
        ...
        if (0 != t.length) {
            var i, n, o = !1, a = function() {
                (i = t[0].offsetHeight,
                n = t.offset().top + i,
                t.hasClass("has-dropdown")) && (t.find(".category-dropdown .dropdown-box").length && (n += t.find(".category-dropdown .dropdown-box")[0].offsetHeight));
                !o && window.innerWidth >= Riode.defaults.stickyHeader.activeScreenWidth && (o = !0,
                t.wrap('<div class="sticky-wrapper" style="height:' + i + 'px"></div>')),
                Riode.$window.off("resize", a)
            }, s = function() {
                window.innerWidth >= Riode.defaults.stickyHeader.activeScreenWidth && window.pageYOffset >= n ? (t[0].classList.add("fixed"),
                document.body.classList.add("sticky-header-active")) : (t[0].classList.remove("fixed"),
        ...
        if (0 != i.length) {
            var a = function() {
                i.each((function(e) {
                    var t = $(this);
                    if (t.data("is-wrap"))
                        (window.innerWidth < n.minWidth || window.innerWidth >= n.maxWidth) && (t.unwrap(".sticky-content-wrapper"),
                        t.data("is-wrap", !1));
                    else {
                        ...
                        t.data("top", i),
                        function(e, t) {
                            window.innerWidth >= n.minWidth && window.innerWidth <= n.maxWidth && (e.wrap('<div class="sticky-content-wrapper"></div>'),
              ...
              , s = function(e) {
                e && !e.isTrusted || i.each((function(e) {
                    var t = $(this)
                      , i = !0;
                    n.scrollMode && (i = o > window.pageYOffset,
                    o = window.pageYOffset),
                    window.pageYOffset > (0 == n.top ? t.data("top") : n.top) && window.innerWidth >= n.minWidth && window.innerWidth <= n.maxWidth ? (t.hasClass("fix-top") ? (void 0 === t.data("offset-top") && function(e) {
                        var t = 0
                          , i = 0;
                    ...
                    t.css("margin-top", t.data("offset-top") + "px")) : t.hasClass("fix-bottom") && (void 0 === t.data("offset-bottom") && function(e) {
                        var t = 0
                          , i = 0;
                    ...
                    n.scrollMode ? i && t.hasClass("fix-top") || !i && t.hasClass("fix-bottom") ? (t.addClass("fixed"),
                    t.closest(".page-wrapper").find(".header").hasClass(".header-transparent") && (Riode.$body.hasClass("sidebar-active") || Riode.$body.hasClass("top-sidebar-active") || Riode.$body.hasClass("right-sidebar-active") ? t.closest(".main").css("z-index", "unset") : t.closest(".main").css("z-index", "19"))) : (t.removeClass("fixed"),
                    t.css("margin", ""),
                    t.closest(".page-wrapper").find(".header").hasClass(".header-transparent") && (Riode.$body.hasClass("sidebar-active") || Riode.$body.hasClass("top-sidebar-active") || Riode.$body.hasClass("right-sidebar-active") ? t.closest(".main").css("z-index", "unset") : t.closest(".main").css("z-index", "19"))) : t.addClass("fixed"),
                    n.hide && t.parent(".sticky-content-wrapper").css("display", "")) : (t.removeClass("fixed"),
                    t.css("margin-top", ""),
                    t.css("margin-bottom", ""),
                    n.hide && t.parent(".sticky-content-wrapper").css("display", "none"))
                }
                ))
            }
              , r = function(e) {
    ...
    Riode.initAccordion = function(e) {
        Riode.$body.on("click", e, (function(e) {
            ...
            e.preventDefault(),
            0 === o.find(".collapsing").length && 0 === o.find(".expanding").length && (n.hasClass("expanded") ? o.hasClass("radio-type") || t(n) : n.hasClass("collapsed") && (o.find(".expanded").length > 0 ? Riode.isIE ? t(o.find(".expanded"), (function() {
                t(n)
            }
            )) : (t(o.find(".expanded")),
            t(n)) : t(n)))
        ...
        var t = function(t, i) {
            ...
            t.hasClass("expanded") ? (n.removeClass("collapse").addClass("expand"),
            t.addClass("collapsing").slideUp(300, (function() {
                t.removeClass("expanded collapsing").addClass("collapsed"),
                i && i()
            }
            ))) : t.hasClass("collapsed") && (n.removeClass("expand").addClass("collapse"),
    ...
    Riode.playableVideo = function(e) {
        $(e + " .video-play").on("click", (function(t) {
            ...
            i.hasClass("playing") ? i.removeClass("playing").addClass("paused").find("video")[0].pause() : i.removeClass("paused").addClass("playing").find("video")[0].play(),
            t.preventDefault()
        }
        )),
    ...
    Riode.stickySidebar = function(e) {
        $.fn.themeSticky && Riode.$(e).each((function() {
            var e = $(this);
            e.themeSticky($.extend(Riode.defaults.stickySidebar, Riode.parseOptions(e.attr("data-sticky-options")))),
    ...
    Riode.ratingTooltip = function(e) {
        for (var t = Riode.byClass("ratings-full", e || document.body), i = t.length, n = function() {
            ...
            t[o].addEventListener("mouseover", n, {
                passive: !0
            }),
    ...
    Riode.scrollSet = function(e) {
        ...
        Riode.$body.on("click", e, (function(e) {
            ...
            n.startsWith("#") && ($(".mobile-menu-overlay").click(),
            Riode.scrollTo(n),
            e.preventDefault()),
    ...
    Riode.requestInterval = function(e, t, i) {
        ...
        if (!n)
            return i ? setInterval(e, t) : setTimeout(e, i);
        var o, a, s = new Object;
        return s.val = n((function r(d) {
            o || (o = a = d),
            !i || d - o < i ? d - a > t ? (s.val = n(r),
            e(),
            a = d) : s.val = n(r) : e()
        }
        )),
    ...
    Riode.sidebar = function() {
        var e = window.innerWidth < Riode.minDesktopWidth
          , t = function() {
            window.innerWidth < Riode.minDesktopWidth && !e ? (this.$sidebar.find(".sidebar-content, .filter-clean").removeAttr("style"),
            this.$sidebar.find(".sidebar-content").attr("style", ""),
            this.$sidebar.siblings(".toolbox").children(":not(:first-child)").removeAttr("style")) : window.innerWidth >= Riode.minDesktopWidth && !this.$sidebar.hasClass("closed") && e && (this.$sidebar.addClass("closed"),
        ...
        return i.prototype.init = function(e) {
            ...
            Riode.$window.on("resize", (function() {
                ...
                Riode.$body.find(".header").hasClass("header-transparent") && setTimeout((function() {
        ...
        i.prototype.toggle = function() {
            ...
            if (window.innerWidth >= Riode.minDesktopWidth && e.$sidebar.hasClass("sidebar-fixed")) {
                ...
                if (e.isNavigation && (t || e.$sidebar.find(".filter-clean").hide(),
                ...
                e.$sidebar.hasClass("shop-sidebar")) {
                    ...
                    if (i.length)
                        if (i.hasClass("product-lists"))
                            ...
                            t ? 4 === a && 3 == n && i.removeClass("cols-md-4") : 3 === a && (i.addClass("cols-md-4"),
    ...
    Riode.initProductSingle = function() {
        ...
        var t = function(e) {
            ...
            i >= t + e.$productThumb[0].offsetHeight ? (e.$thumbs.css("top", parseInt(e.$thumbs.css("top")) - e.$productThumb[0].offsetHeight),
            e.$thumbUp.removeClass("disabled")) : i > t ? (e.$thumbs.css("top", parseInt(e.$thumbs.css("top")) - Math.ceil(i - t)),
            e.$thumbUp.removeClass("disabled"),
            e.$thumbDown.addClass("disabled")) : e.$thumbDown.addClass("disabled")
        }
          , i = function(e) {
            var t = e.$thumbsWrap.offset().top
              , i = e.$thumbs.offset().top;
            i <= t - e.$productThumb[0].offsetHeight ? (e.$thumbs.css("top", parseInt(e.$thumbs.css("top")) + e.$productThumb[0].offsetHeight),
            e.$thumbDown.removeClass("disabled")) : i < t ? (e.$thumbs.css("top", parseInt(e.$thumbs.css("top")) - Math.ceil(i - t)),
            e.$thumbDown.removeClass("disabled"),
            e.$thumbUp.addClass("disabled")) : e.$thumbUp.addClass("disabled")
        }
          , n = function(e) {
            if (void 0 !== e.$thumbs) {
                ...
                e.thumbsIsVertical ? (e.$thumbs.hasClass("owl-carousel") && e.$thumbs.trigger("destroy.owl.carousel").removeClass("owl-carousel"),
                ...
                e.isQuickview && o()) : (t && e.$thumbs.css("top", ""),
                e.$thumbs.hasClass("owl-carousel") || e.$thumbs.addClass("owl-carousel").owlCarousel($.extend(!0, e.isQuickview ? {
                    onInitialized: o,
                    onResized: o
        ...
        return e.prototype.init = function(e) {
            ...
            s.on("initialized.owl.carousel", (function(e) {
                ...
                s.parent().hasClass("product-gallery-degree") && (a.isQuickView || s.append('<a href="#" class="product-gallery-btn product-degree-viewer" title="Product 360 Degree Gallery"><i class="w-icon-rotate-3d"></i></a>')),
                function(e) {
            ...
            "complete" === Riode.status && (Riode.slider(s),
            ...
            function(e) {
                e.$wrapper.on("click", ".btn-cart", (function(t) {
                    ...
                    (i.closest(".product-popup").length || document.body.classList.contains("home")) && Riode.Minipopup.open({
                        ...
                        actionTemplate: '<div class="action-group d-flex mt-3"><a href="carrito.php" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">Ver Carrito</a><a href="checkout.html" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
                    })
                }
                ))
            }(this),
        ...
        e.prototype.thumbsSetActive = function(e) {
            var t = this
              , i = t.$thumbsDots.eq(e);
            if (t.$thumbsDots.filter(".active").removeClass("active"),
            i.addClass("active"),
            t.thumbsIsVertical) {
                ...
                t.$thumbs.trigger("to.owl.carousel", e, 100)
        }
        ,
        ...
        e.prototype.variationMatch = function() {
            var e = this;
            e.$priceWrap.find("span").text("$" + (Math.round(50 * Math.random()) + 200) + ".00"),
    ...
    Riode.initProductSinglePage = function() {
        ...
        function t(e) {
            ...
            "disabled" != t.find(".btn-product.btn-cart").attr("disabled") && Riode.Minipopup.open({
                ...
                actionTemplate: '<div class="action-group d-flex mt-3"><a href="comparar.php" class="btn btn-sm btn-outline btn-primary btn-rounded mr-2">Comparar</a><a href="checkout.php" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
            })
        }
        function i(e) {
            e.preventDefault();
        ...
        function o(e) {
            ...
            t.hasClass("added") || (e.preventDefault(),
        ...
        return function() {
            ...
            return Riode.$body.on("click", ".product-single .btn-wishlist", o),
            s.length ? document.body.classList.contains("home") ? (s.each((function() {
                Riode.initProductSingle($(this))
            }
            )),
            Riode.zoomImage(".product-gallery.row"),
            null) : null === Riode.initProductSingle(s) ? null : (Riode.$body.on("click", ".product-single .product-image-full", i),
            ...
            Riode.$body.on("click", ".btn.like", (function(e) {
                ...
                t.closest(".feeling").find(".btn.unlike").removeClass("active"),
                t.closest(".feeling").find(".btn.unlike .count").text("0")
            }
            )),
            void Riode.$body.on("click", ".btn.unlike", (function(e) {
                ...
                t.toggleClass("active"),
                t.find(".count").text(1 - i),
                t.closest(".feeling").find(".btn.like").removeClass("active"),
    ...
    Riode.slider = function() {
        ...
        var t = function(e) {
            ...
            for (this.classList.remove("row"),
            a = 0; a < 7; ++a)
                for (t = 1; t <= 12; ++t)
                    this.classList.remove("cols" + i[a] + "-" + t);
            if (this.classList.remove("gutter-no"),
          ...
          , i = function(e) {
            ...
            s.find("video").on("ended", (function() {
                $(this).closest(".owl-item").hasClass("active") && (!0 === s.data("owl.carousel").options.autoplay ? (!1 === s.data("owl.carousel").options.loop && s.data().children - 1 === s.find(".owl-item.active").index() && (this.loop = !0,
                this.play()),
                s.trigger("next.owl.carousel"),
                s.trigger("play.owl.autoplay")) : (this.loop = !0,
                this.play()))
            }
            ))
        }
          , n = function(e) {
            ...
            i.length && (!0 === t.data("owl.carousel").options.autoplay && t.trigger("stop.owl.autoplay"),
            i.each((function() {
          ...
          , r = function(e) {
            ...
            if (1 == t.translateFlag) {
                if (t.next = i.find(".owl-item").eq(e.item.index).children().attr("data-index"),
        ...
        e.zoomImageRefresh = function() {
            this.$element.find("img").each((function() {
                ...
                if ($.fn.elevateZoom) {
                    ...
                    void 0 !== t ? t && t.refresh() : (Riode.defaults.zoomImage.zoomContainer = e.parent(),
        ...
        e.prototype.init = function(e, d) {
            ...
            $.extend(!0, c, Riode.parseOptions(e.attr("data-owl-options")), d),
            o = o.bind(this),
            s = s.bind(this),
            r = r.bind(this),
            e.on("initialize.owl.carousel", t).on("initialized.owl.carousel", i).on("translated.owl.carousel", n),
            e.hasClass("animation-slider") && e.on("initialized.owl.carousel", o).on("resized.owl.carousel", a).on("translate.owl.carousel", s).on("translated.owl.carousel", r),
            e.owlCarousel(c)
        }
        ,
        function(t, i) {
    ...
    Riode.quantityInput = function() {
        ...
        e.prototype.init = function(t) {
            ...
            i.$minus = t.prev().on("mousedown", (function(e) {
                e.preventDefault(),
                i.startDecrease()
            }
            ...
            i.$plus = t.next().on("mousedown", (function(e) {
                e.preventDefault(),
                i.startIncrease()
            }
            )).on("touchstart", (function(e) {
        ...
        initShowDemos: function() {
            ...
            $(".demo-toggle").on("click", (function(e) {
                ...
                function() {
                    ...
                    0 == e.children().length && (Riode.doLoading(t),
                    $.ajax({
    ...
    Riode.Minipopup = function() {
        ...
        return {
            ...
            open: function(n, r) {
                var d, l = this, c = $.extend(!0, {}
                , Riode.defaults.minipopup, n);
                ...
                l.space = c.space,
                d.appendTo(e).css("top", -t).find("img")[0].onload = function() {
                    t += d[0].offsetHeight + l.space,
                    d.addClass("show"),
                    d.offset().top - window.pageYOffset < 0 && (l.close(),
    ...
    Riode.floatSVG = function() {
        ...
        e.prototype.draw = function() {
            ...
            this.width && (this.$el.find("path").each((function() {
                var i = t
                  , n = 0;
                this.setAttribute("d", $(this).data("original").replace(/M([\d|\.]*),([\d|\.]*)/, (function(t, o, a) {
                    ...
                    if (a) {
                        ...
                        if (6 == s.length)
                            return "C" == a ? (s[1] += e.getDeltaY(t + s[0]),
                            s[3] += e.getDeltaY(t + s[2]),
                            s[5] += e.getDeltaY(i = t + s[4])) : (s[1] += e.getDeltaY(i + s[0]) - n,
    ...
    Riode.Shop = {
        ...
        initVariation: function(e) {
            $(".product:not(.product-single) .product-variations > a").on("click", (function(e) {
                ...
                t.hasClass("active") ? i.attr("src", t.data("src")) : (i.attr("src", i.data("image-src")),
                t.blur()),
                e.preventDefault()
            }
            ))
        ...
        initProductType: function(e) {
            ...
            $(Riode.byClass("product-slideup-content")).on("mouseenter touchstart", (function(e) {
                var t = $(this)
                  , i = t.find(".product-hide-details").outerHeight(!0);
                t.find(".product-details").css("transform", "translateY(" + -i + "px)"),
                t.find(".product-hide-details").css("transform", "translateY(" + -i + "px)")
            }
        ...
        initSelectMenu: function() {
            Riode.$body.on("click", ".select-menu", (function(e) {
                ...
                if (!t.hasClass("toolbox-sort")) {
                    ...
                    i.is(n.parent()) ? (o || i.addClass("opened"),
                    e.stopPropagation()) : (n.parent().toggleClass("active"),
                    n.parent().hasClass("active") ? ($(".select-items").show(),
                    $('<a href="#" class="select-item">' + n.text() + '<i class="d-icon-times"></i></a>').insertBefore(".select-items .filter-clean").hide().fadeIn().data("link", n.parent())) : $(".select-items > .select-item").filter((function(e, t) {
                ...
                t.hasClass("search-ul") || t.parent().hasClass("select-menu") || (t.hasClass("filter-price") ? ($(this).parent().siblings().removeClass("active"),
        ...
        initProductsQuickview: function() {
            Riode.$body.on("click", ".btn-quickview", (function(e) {
                ...
                e.preventDefault(),
                $(this).closest(".dark-theme").length > 0 ? Riode.popup({
                    items: {
                        src: "ajax/vistarapida-dark.php?id=" + idProduct
                    },
                    callbacks: {
                        ajaxContentAdded: function() {
                    ...
                    items: {
                        src: "ajax/vistarapida.php?id=" + idProduct
                    },
                    callbacks: {
                        ajaxContentAdded: function() {
                            this.wrap.imagesLoaded((function() {
        ...
        initProductsCartAction: function() {
            Riode.$body.on("click", ".off-canvas .cart-toggle", (function(e) {
                ...
                Riode.Minipopup.open({
                    ...
                    actionTemplate: '<div class="action-group d-flex"><a href="carrito.php" class="btn btn-sm btn-outline btn-primary btn-rounded">Ver Carrito</a><a href="checkout.html" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
                })
            }
            ))
        },
        initProductsCompareAction: function() {
            Riode.$body.on("click", ".off-canvas .compare-toggle", (function(e) {
                ...
                t.hasClass("product-single") || Riode.Minipopup.open({
                    ...
                    count: t.find(".quantity").length > 0 ? t.find(".quantity").val() : 1,
                    actionTemplate: '<div class="action-group d-flex"><a href="compare.html" class="btn btn-sm btn-outline btn-primary btn-rounded">Comparar</a><a href="checkout.html" class="btn btn-sm btn-primary btn-rounded">Check Out</a></div>'
                })
            }
            ))
        },
        ...
        initProductsLoginAction: function() {
            Riode.$body.on("click", ".login-toggle", (function(e) {
                e.preventDefault();
                $(".login-dropdown").addClass("opened")
                $("#tsignin").addClass("active");
                $("#signin").addClass("active");
                $("#singin-email").focus();
                $("#tregister").removeClass("active");
                $("#register").removeClass("active");
            }
            )).on("click", ".register-toggle", (function(e) {
                e.preventDefault();
                $(".login-dropdown").addClass("opened")
                $("#tregister").addClass("active");
                $("#register").addClass("active");
                $("#nombre").focus();
                $("#tsignin").removeClass("active");
